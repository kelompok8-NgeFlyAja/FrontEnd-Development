...
const ModalPassenger = ({
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 md:absolute md:top-full md:left-[50px] flex items-center justify-center z-10">
        <div
          className="absolute md:top-full md:left-[50px] bg-white p-6 rounded-lg shadow-lg flex flex-col z-10 ms-1 md:ms-0 w-[380px] md:w-[400px] md:h-[306px]"
          style={{
            borderRadius: "20px",
            padding: "24px 0",
          }}
