...
function Filter() {
  ...
  const [cabinBaggageRange, setCabinBaggageRange] = useState({ min: "", max: "" });
    ...
    <div className="max-w-sm ml-[185px] pr-[100px]">
      <div className="max-w-sm bg-white shadow-lg rounded-lg py-6 px-4 shadow-md">
        ...
        <div className="border-b pb-3 mb-3">
          <div className="flex items-center justify-between cursor-pointer" onClick={() => toggleFilter("transit")}>
            <div className="flex items-center gap-3">
              <img src="/icons/fi_box.svg" alt="Transit" />
              <span className="text-gray-700">Transit</span>
            </div>
            <img src="icons/fi_chevron-right.svg" alt="right" className={`transition-transform ${activeFilter === "transit" ? "rotate-90" : ""}`} />
          </div>
        ...
        {/* Filter Fasilitas */}
        <div className="border-b pb-3 mb-3">
          <div className="flex items-center justify-between cursor-pointer" onClick={() => toggleFilter("facilities")}>
            <div className="flex items-center gap-3">
              <img src="/icons/fi_heart.svg" alt="Fasilitas" />
              <span className="text-gray-700">Fasilitas</span>
            </div>
            <img src="icons/fi_chevron-right.svg" alt="right" className={`transition-transform ${activeFilter === "facilities" ? "rotate-90" : ""}`} />
          </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setFacilities({ ...facilities, baggage: e.target.checked })}
                    className="peer bg-white border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500"
                  />
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="peer bg-white border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500"
                  />
                  <label htmlFor="inFlightEntertainment" className="text-gray-700">
        ...
        <div>
          <div className="flex items-center justify-between cursor-pointer" onClick={() => toggleFilter("price")}>
            ...
            <img src="icons/fi_chevron-right.svg" alt="right" className={`transition-transform ${activeFilter === "price" ? "rotate-90" : ""}`} />
          </div>
          {activeFilter === "price" && (
            <div className="mt-3">
              <div className="flex gap-2">
                <input type="number" placeholder="Min" value={priceRange.min} onChange={(e) => setPriceRange({ ...priceRange, min: e.target.value })} className="border border-gray-300 rounded-md p-2 w-full focus:outline-none" />
                <input type="number" placeholder="Max" value={priceRange.max} onChange={(e) => setPriceRange({ ...priceRange, max: e.target.value })} className="border border-gray-300 rounded-md p-2 w-full focus:outline-none" />
              </div>
            </div>
          )}
        </div>
